...
<body>
	<%
		if (session.getAttribute("usuLogeado") == null || session.isNew()) {
			...
			int usu = ((Usuario) session.getAttribute("usuLogeado")).getIdUsuario();
			
			ArrayList<Anuncio> anuncios2 = AnuncioDAO.listarAnunciosPorUsuario(usu);
				...
				<table class="table table-striped custab">
					...
					<tr>
						...
						<%-- <a href="editarLibro.jsp?idLibro=<%=l.getIdLibro()%>"
							...
							<a href="editarAnuncio.jsp?encrypt=<%=a.getUuid()%>"
							class='btn btn-info btn-xs'><span
								class="glyphicon glyphicon-edit"></span>Editar</a>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<p>¿Desea borrar el libro <%=a.getIdAnuncio() %>?</p>
										</div>
										<div class="modal-footer">
											<div class="btn-group">
												...
												<a href="../BorrarAnuncio?encrypt=<%=a.getUuid()%>" class="btn btn-primary">
													<span class="glyphicon glyphicon-check"></span> Borrar
												</a>
											</div>
										</div>
							...
							<!-- /.modal --> 
							<a data-toggle="modal" href="#myModal<%=a.getIdAnuncio() %>"
